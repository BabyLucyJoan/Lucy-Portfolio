  ...
  return (
    <section id="designs" className="section">
      ...
      >
        ...
        <p style={{ color: 'var(--text-2)', fontSize: 'clamp(0.82rem,2vw,0.9rem)', lineHeight: 1.75, maxWidth: 560, marginBottom: '2rem' }}>
        ...
        <div style={{
          ...
          <div>
            <p style={{ fontFamily: 'var(--mono)', fontSize: '0.6rem', color: 'var(--text-3)', marginBottom: '0.1rem' }}>TOOL</p>
            <p style={{ fontSize: '0.82rem', fontWeight: 600, color: 'var(--acc)' }}>Canva — Graphic Design</p>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', gap: '0.45rem', flexWrap: 'wrap', marginBottom: '2rem' }}>
          {CATS.map(cat => (
            <button key={cat} onClick={() => setFilter(cat)} style={filterStyle(cat)}>
              {cat}
            </button>
          ))}
        </div>
        ...
        {/* CTA to add real designs */}
        <div style={{
          marginTop: '2.5rem', padding: '1.5rem',
          borderRadius: 14, border: '1px dashed var(--border-hi)',
          ...
          <div style={{ flex: 1, minWidth: 200 }}>
            <p style={{ fontSize: '0.82rem', fontWeight: 600, marginBottom: '0.25rem' }}>
              Add your real Canva designs
            </p>
            <p style={{ fontSize: '0.75rem', color: 'var(--text-3)', lineHeight: 1.6 }}>
              Export designs from Canva and add the images to <code style={{ fontFamily: 'var(--mono)', color: 'var(--acc)', fontSize: '0.72rem' }}>public/designs/</code>, then update the <code style={{ fontFamily: 'var(--mono)', color: 'var(--acc)', fontSize: '0.72rem' }}>DESIGNS</code> array in <code style={{ fontFamily: 'var(--mono)', color: 'var(--acc)', fontSize: '0.72rem' }}>portfolioData.js</code> with an <code style={{ fontFamily: 'var(--mono)', color: 'var(--acc)', fontSize: '0.72rem' }}>image</code> field.
            </p>
          </div>
        </div>
